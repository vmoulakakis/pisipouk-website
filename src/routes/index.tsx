...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Παιδικός Σταθμός & Νηπιαγωγείο Άγιος Δημήτριος | Ο Πισιπούκ" },
      {
        name: "description",
        content:
          "Ο Πισιπούκ είναι παιδικός σταθμός και νηπιαγωγείο στον Άγιο Δημήτριο για παιδιά 2,5–6 ετών. Δημιουργική μάθηση, ολοήμερο πρόγραμμα και ουσιαστική συνεργασία με την οικογένεια.",
      },
      {
        property: "og:title",
        content: "Παιδικός Σταθμός & Νηπιαγωγείο Άγιος Δημήτριος | Ο Πισιπούκ",
      },
      {
        property: "og:description",
        content: "Παιδικός σταθμός και νηπιαγωγείο στον Άγιο Δημήτριο για παιδιά 2,5–6 ετών. Ελάτε να γνωρίσετε τον χώρο και την ομάδα μας.",
      },
