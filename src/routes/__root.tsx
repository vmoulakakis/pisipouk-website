...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://pisipouk.vercel.app/og-image.webp" },
      { property: "og:image:alt", content: "Ο Πισιπούκ — Παιδικός Σταθμός & Νηπιαγωγείο στον Άγιο Δημήτριο" },
      ...
      { name: "twitter:image", content: "https://pisipouk.vercel.app/og-image.webp" },
    ],
  }),
